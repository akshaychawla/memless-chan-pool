...
python perftest.py --module=PRCNPTN --batch_size=16 --ip_chans=16 --op_chans=64 --h=16 --w=16 --CMP=4 --G=12 --numsamples=50 
...
# height/width variation
python perftest.py --module=FastPRCNPTN --batch_size=16 --ip_chans=16 --op_chans=64 --h=16 --w=16 --CMP=4 --G=12 --numsamples=50 
python perftest.py --module=FastPRCNPTN --batch_size=16 --ip_chans=16 --op_chans=64 --h=32 --w=32 --CMP=4 --G=12 --numsamples=50 
python perftest.py --module=FastPRCNPTN --batch_size=16 --ip_chans=16 --op_chans=64 --h=64 --w=64 --CMP=4 --G=12 --numsamples=50 
